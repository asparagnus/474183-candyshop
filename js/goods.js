...
var products = []; // vмассив для товаров
...
// При клике по card__btn массив products копируется по id в массив корзины.
// event.currentTarget используется, когда один и тот же обработчик события присваивается нескольким элементам.
// Можно отследить где событие изначально произошло
